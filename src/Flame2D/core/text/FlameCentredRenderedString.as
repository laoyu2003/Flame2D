...
package Flame2D.core.text
{
    ...
    public class FlameCentredRenderedString extends FlameFormattedRenderedString
    {
        protected var d_offsets:Vector.<Number> = new Vector.<Number>();
        
        
        //! Constructor.
        public function FlameCentredRenderedString(rs:FlameRenderedString)
        {
            super(rs);
        }
        ...
        override public function format(area_size:Size):void
        {
            ...
            for (var i:uint = 0; i < d_renderedString.getLineCount(); ++i)
                d_offsets.push((area_size.d_width - d_renderedString.getPixelSize(i).d_width) / 2.0);
        }
                        ...
                        mod_colours:ColourRect, clip_rect:Rect):void
        {
            ...
            for (var i:uint = 0; i < d_renderedString.getLineCount(); ++i)
            {
                ...
                d_renderedString.draw(i, buffer, draw_pos.clone(), mod_colours, clip_rect, 0.0);
