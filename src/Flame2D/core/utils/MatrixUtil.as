...
package Flame2D.core.utils
{
    ...
    public class MatrixUtil
    {
        ...
        {
            throw new Error("Error in construction Matrix, not used this way");
        }
        ...
        public static function makeOrthoProjection(w:Number, h:Number, n:Number, f:Number):Matrix3D
        {
        ...
        public static function makeOrthographicProjection(w:Number, h:Number, n:Number, f:Number):Matrix3D
        {
            return new Matrix3D(Vector.<Number>
                ([                
                    2.0/w, 0.0, 0.0, 0.0,
