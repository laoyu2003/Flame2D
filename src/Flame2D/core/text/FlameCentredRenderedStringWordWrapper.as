...
package Flame2D.core.text
{
    ...
    public class FlameCentredRenderedStringWordWrapper extends FlameFormattedRenderedString
    {
        ...
        //! Constructor.
        public function FlameCentredRenderedStringWordWrapper(rs:FlameRenderedString)
        {
            super(rs);
        }
        ...
        override public function format(area_size:Size):void
        {
            ...
            var frs:FlameCentredRenderedString;
            ...
            for (var line:uint = 0; line < rstring.getLineCount(); ++line)
            {
                while ((rs_width = rstring.getPixelSize(line).d_width) > 0)
                {
                    ...
                    frs = new FlameCentredRenderedString(lstring);
            ...
            // last line.
            frs = new FlameCentredRenderedString(rstring);
            frs.format(area_size);
            d_lines.push(frs);
        }
