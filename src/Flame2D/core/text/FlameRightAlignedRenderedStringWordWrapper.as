...
package Flame2D.core.text
{
    ...
    public class FlameRightAlignedRenderedStringWordWrapper extends FlameFormattedRenderedString
    {
        ...
        //! Constructor.
        public function FlameRightAlignedRenderedStringWordWrapper(rs:FlameRenderedString)
        {
            super(rs);
        }
        ...
        override public function format(area_size:Size):void
        {
            ...
            var frs:FlameRightAlignedRenderedString;
            ...
            for (var line:uint = 0; line < rstring.getLineCount(); ++line)
            {
                while ((rs_width = rstring.getPixelSize(line).d_width) > 0)
                {
                    ...
                    frs = new FlameRightAlignedRenderedString(lstring);
            ...
            // last line.
            frs = new FlameRightAlignedRenderedString(rstring);
            frs.format(area_size);
            d_lines.push(frs);
        }
